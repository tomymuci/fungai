...
all_info_tables = {
    ...
    Amanita Phalloides (Death Cap Mushroom). Its most noticeable species is the
    famous Amanita Muscaria - highly identifiable from its vibrant red cap with
    white spots which also contains psychoactive compounds that induce altered states
    of consciousness.
...
,
    ...
    the root systems of certain plants (including trees), providing immune support
    and aiding nutrient exchange between the ecosystem. The Boletus genus contains a
    few edible mushrooms, with the most notable being Boletus Edulis.
    There are many toxic species, and an easy rule of thumb to guide any forager
    is to avoid Bolet’s with red Hymenial pores. """
    ,
    ...
    societies across the world. All Cortinarius mushrooms share a mycorrhizal
    relationship (symbiotic relationship) with the plant's rhizosphere
    ...
    Most Entoloma have gray and bland color pallets, but some species found in
    Australian and New Zealand (Entoloma Rodwayi and Entoloma Hoschtetteri)
    are a vibrant green and blue. Due to many species being toxic to humans,
    it is discouraged to forage them for culinary purposes.  """
    ...
    mycorrhizal nature. A few notable species include Hygrocybe Coccinea, Hygrocybe
    Strangulata, and Hygrocybe Cantharellus. """
    ...
    There are over 500 different species of Lactarius, with all of them being
    ectomycorrhizal fungi. In Spain, Lactarius Deliciosi are known as Niscalos
    and sell for over 50 Euros/kg and are regarded as a delicacy.  """
